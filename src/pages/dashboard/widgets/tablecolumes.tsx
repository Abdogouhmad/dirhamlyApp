...
export function getTableColumns(
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div
          className={`text-left font-semibold ${type === "income" ? "text-green-500" : "text-red-500"
            }`}
        >
          {type === "income" ? "+" : "-"}
          {formatted}
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex justify-center">
          <button
            onClick={() => onDelete(id)}
            className="text-red-400 hover:text-red-600 transition-all duration-200 p-1.5 rounded-md hover:bg-red-500/10 group"
